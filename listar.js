...
function editarUsuario(userId) {
    ...
    .then(data => {
        ...
        // Adiciona um evento de submit no formulário de edição
        ...
        formEditar.onsubmit = async function(e) {
            ...
            const userAtualizado = {
                ...
                password: document.getElementById('editarSenha').value,
                password_confirmation: document.getElementById('editarSenhaConfirmacao').value
            };

            // Verificar se a senha e a confirmação correspondem
            if (userAtualizado.password !== userAtualizado.password_confirmation) {
                alert('A confirmação de senha não corresponde.');
                return;
            }

            // Fazer a requisição para atualizar os dados do usuário
            try {
                ...
                if (response.ok) {
                    ...
                    editarModal.hide(); // Fechar o modal
                } else {
    ...
    .catch(error => {
        console.error('Erro ao obter os dados do usuário para edição:', error);
    });
}

// Adiciona o evento de clique para editar o usuário (pode ser na lista de usuários)
